...
void CGame::Init()
{
	...
	case Level::One:
	{
		...
		CBird *bird1 = new CBird(m_world, {226, 800}, 25, b2_dynamicBody, "Circle.png");
		m_allBirds.push_back(bird1);
		CBody *squareBody = new CBody(m_world, {200, 700}, {50, 50}, b2_dynamicBody, "Rect.png");
		m_allBlocks.push_back(squareBody);
		CBody *rectBody = new CBody(m_world, {226, 800}, {100, 50}, b2_dynamicBody, "Rect.png");
	...
	case Level::Two:
	{
		...
		CBird *circleBody = new CBird(m_world, {426, 800}, 25, b2_dynamicBody, "Circle.png");
		m_allBirds.push_back(circleBody);
		CBody *squareBody = new CBody(m_world, {200, 300}, {50, 50}, b2_dynamicBody, "Rect.png");
		m_allBlocks.push_back(squareBody);
