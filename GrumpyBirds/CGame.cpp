...
void CGame::Init()
{
	...
	case Level::One: {
		...
		CBody* bird1 = new CBody(m_world, { 226,800 }, 25, b2_dynamicBody, "Circle.png");				m_allBirds.push_back(bird1);
	...
	case Level::Two: {
		...
		CBody* circleBody = new CBody(m_world, { 426,800 }, 25, b2_dynamicBody, "Circle.png");							m_allBirds.push_back(circleBody);
...
void CGame::Clear()
{
	...
	for (CBody* _body : m_allBirds) { _body->Destroy(); };		m_allBirds.clear();
